...
export function DropdownNav () {
    ...
    return (
        <nav className='navbarDropdown'>
            ...
            <NavLink className={({isActive}) => {return isActive ? 'activeNav' : 'navbarOption'}} to='FeedbackReports'><FontAwesomeIcon className='navbarIcon' icon="fa-solid fa-square-poll-vertical" />Reports</NavLink>
